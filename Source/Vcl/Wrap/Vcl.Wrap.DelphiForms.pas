...
unit Vcl.Wrap.DelphiForms;

interface

uses
  Classes, SysUtils, Windows, Forms, Graphics, TypInfo,
  PythonTypes, PythonEngine, WrapDelphi,
  Vcl.Wrap.DelphiClasses, Vcl.Wrap.DelphiControls;
